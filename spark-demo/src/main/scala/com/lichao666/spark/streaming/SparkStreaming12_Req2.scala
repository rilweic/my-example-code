package com.lichao666.spark.streaming

import java.text.SimpleDateFormat

import com.lichao666.spark.streaming.SparkStreaming11_Req1_BlackList.AdClickData
import com.lichao666.spark.util.JDBCUtil
