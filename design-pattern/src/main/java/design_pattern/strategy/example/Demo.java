package design_pattern.strategy.example;

import design_pattern.strategy.example.order.Order;
import design_pattern.strategy.example.strategies.PayByCreditCard;
import design_pattern.strategy.example.strategies.PayByPayPal;
import design_pattern.strategy.example.strategies.PayStrategy;
